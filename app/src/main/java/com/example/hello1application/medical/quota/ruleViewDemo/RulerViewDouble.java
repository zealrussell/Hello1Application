 ...
 * 尺图
 */
public class RulerViewDouble extends View {
    ...
    public RulerViewDouble(Context context) {
        this(context, null);
    }

    public RulerViewDouble(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        grayLinePaint.setColor(getResources().getColor(R.color.colorPrimaryDark));
        grayLinePaint.setStrokeWidth(5);

        txtPaint = new Paint();
        txtPaint.setAntiAlias(true);
        txtPaint.setColor(getResources().getColor(R.color.colorPrimaryDark));
