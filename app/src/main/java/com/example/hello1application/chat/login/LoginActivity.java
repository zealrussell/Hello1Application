...
/**
 * use {@link com.example.hello1application.chat.login.SMSLoginActivity} instead
 */
@Deprecated
public class LoginActivity extends WfcBaseActivity {
    ...
    void login() {
        ...
        com.example.hello1application.chat.AppService.Instance().namePwdLogin(account, password, new com.example.hello1application.chat.AppService.LoginCallback() {
            @Override
