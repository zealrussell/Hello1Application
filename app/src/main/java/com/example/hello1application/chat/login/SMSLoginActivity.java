    ...
    void login() {
        ...
        com.example.hello1application.chat.AppService.Instance().smsLogin(phoneNumber, authCode, new com.example.hello1application.chat.AppService.LoginCallback() {
            ...
            public void onUiFailure(int code, String msg) {
                ...
                Toast.makeText(com.example.hello1application.chat.login.SMSLoginActivity.this, "登录失败：" + code + " " + msg, Toast.LENGTH_SHORT).show();
                dialog.dismiss();
                loginButton.setEnabled(true);
            }
        });
    ...
    void requestAuthCode() {
        ...
        com.example.hello1application.chat.AppService.Instance().requestAuthCode(phoneNumber, new com.example.hello1application.chat.AppService.SendCodeCallback() {
            ...
            public void onUiSuccess() {
                Toast.makeText(com.example.hello1application.chat.login.SMSLoginActivity.this, "发送验证码成功", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onUiFailure(int code, String msg) {
                Toast.makeText(com.example.hello1application.chat.login.SMSLoginActivity.this, "发送验证码失败: " + code + " " + msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
}
