...
public class AppService implements AppServiceProvider {
    private static com.example.hello1application.chat.AppService Instance = new com.example.hello1application.chat.AppService();
    ...
    public void smsLogin(String phoneNumber, String authCode, LoginCallback callback) {
        ...
        //Platform_WEB = 5,
        //Platform_WX = 6,
        params.put("platform", Integer.valueOf(2));
