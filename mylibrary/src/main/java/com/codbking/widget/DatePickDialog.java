...
/**
 * Created by codbking on 2016/8/gouwu.
 */
public class DatePickDialog extends Dialog implements OnChangeLisener{
    ...
    //设置点击确定按钮，回调
    public void setOnSureLisener(OnSureLisener onSureLisener,int sureLister_id) {
        this.onSureLisener = onSureLisener;
        this.sureLister_id = sureLister_id;
    }
        ...
        this.sure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (onSureLisener != null) {
                    //add by myself
                    dateResult = mDatePicker.getSelectDate();

                    onSureLisener.onSure(dateResult,sureLister_id);
                }
            }
        });
    }
